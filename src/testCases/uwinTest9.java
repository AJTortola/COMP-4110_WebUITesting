...
public class uwinTest9 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("idA_IL_ForgotPassword0")).click(); //Will Find the reset link by its id and click it. 

		String currentPage = driver.getTitle(); //Will get the title of the current page it is on
		String expectedTitle = "Microsoft Online Password Reset"; //The expected title of the page
